...
@noinline function minimize!(f, ∇f!, scheme, x0; inverse=true, c=0.001, g_tol=1e-8, max_iter=10^6, ls_max_iter=50, show_trace=false,  show_ls_trace=false)
...
function minimize(f::T1, ∇f::T2, x0, scheme, approx, B0) where {T1, T2}
