...
@testset "NearlyNewton.jl" begin
    ...
    @printf("NN! BFGS (inverse): %2.2e  %2.2e  %d\n", norm(res[1]-xopt,Inf), norm(res[2], Inf), res[3])
    res = minimize!(f, g!, x0, NearlyNewton.BFGS(), NearlyNewton.DirectApprox(), I)
    @time minimize!(f, g!, x0, NearlyNewton.BFGS(), NearlyNewton.DirectApprox(), I)
    @printf("NN! BFGS  (direct): %2.2e  %2.2e  %d\n", norm(res[1]-xopt,Inf), norm(res[2], Inf), res[3])
    ...
    res = minimize(f, g, NearlyNewton.DFP(), x0, NearlyNewton.InverseApprox(), I)
    @printf("NN  DFP  (inverse): %2.2e  %2.2e  %d\n", norm(res[1]-xopt,Inf), norm(res[2], Inf), res[3])
    res = minimize(f, g, NearlyNewton.DFP(), x0, NearlyNewton.DirectApprox(), I)
    ...
    res = minimize(f, g, NearlyNewton.SR1(), x0, NearlyNewton.InverseApprox(), I)
    @printf("NN  SR1  (inverse): %2.2e  %2.2e  %d\n", norm(res[1]-xopt,Inf), norm(res[2], Inf), res[3])
    res = minimize(f, g, NearlyNewton.SR1(), x0, NearlyNewton.DirectApprox(), I)
    ...
    res = minimize(f, gs, NearlyNewton.DFP(), x0s, NearlyNewton.InverseApprox(), I)
    @printf("NN  DFP(S)  (inverse): %2.2e  %2.2e  %d\n", norm(res[1]-xopt,Inf), norm(res[2], Inf), res[3])
    res = minimize(f, gs, NearlyNewton.DFP(), x0s, NearlyNewton.DirectApprox(), I)
    ...
    res = minimize(himmelblau, himmelblau_gradient, NearlyNewton.DFP(), x0, NearlyNewton.InverseApprox(), I)
    @printf("NN  DFP  (inverse): %2.2e  %d\n", norm(res[2], Inf), res[3])
    res = minimize(himmelblau, himmelblau_gradient, NearlyNewton.DFP(), x0, NearlyNewton.DirectApprox(), I)
    ...
    res = minimize(himmelblau, himmelblau_gradient, NearlyNewton.SR1(), x0, NearlyNewton.InverseApprox(), I)
    @printf("NN  SR1  (inverse): %2.2e  %d\n", norm(res[2], Inf), res[3])
    res = minimize(himmelblau, himmelblau_gradient, NearlyNewton.SR1(), x0, NearlyNewton.DirectApprox(), I)
    ...
    res = minimize(himmelblau, himmelblau_gradient, NearlyNewton.DFP(), x0s, NearlyNewton.InverseApprox(), I)
    @printf("NN  DFP(S)  (inverse): %2.2e  %d\n", norm(res[2], Inf), res[3])
    res = minimize(himmelblau, himmelblau_gradient, NearlyNewton.DFP(), x0s, NearlyNewton.DirectApprox(), I)
